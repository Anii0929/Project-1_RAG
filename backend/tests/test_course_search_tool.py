...
class TestCourseSearchTool(unittest.TestCase):
    ...
    def test_execute_basic_query_success(self):
        ...
        self.assertEqual(
            self.search_tool.last_sources[0]["title"], "Python Programming - Lesson 1"
        )
    ...
    def test_execute_with_lesson_filter(self):
        ...
        mock_results = SearchResults(
            ...
            metadata=[{"course_title": "Web Development", "lesson_number": 3}],
            distances=[0.1],
            error=None,
        )
        self.mock_vector_store.search.return_value = mock_results
    ...
    def test_execute_with_both_filters(self):
        ...
        self.mock_vector_store.get_lesson_link.return_value = (
            "https://datascience-lesson5.com"
        )

        result = self.search_tool.execute(
            "content", course_name="Data Science", lesson_number=5
        )

        # Verify the call included both filters
        self.mock_vector_store.search.assert_called_once_with(
            query="content", course_name="Data Science", lesson_number=5
        )
    ...
    def test_execute_empty_results_with_filters(self):
        ...
        result = self.search_tool.execute(
            "topic", course_name="Missing Course", lesson_number=99
        )
    ...
    def test_execute_multiple_results(self):
        ...
        self.mock_vector_store.get_lesson_link.side_effect = (
            lambda course, lesson: f"https://cs.com/lesson{lesson}"
        )
    ...
    def test_execute_no_links_available(self):
        ...
        mock_results = SearchResults(
            ...
            metadata=[{"course_title": "No Links Course", "lesson_number": 1}],
            distances=[0.2],
            error=None,
        )
        self.mock_vector_store.search.return_value = mock_results
