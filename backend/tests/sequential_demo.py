...
from tests.test_ai_generator import MockContentBlock, MockAnthropicResponse
    ...
    with patch('anthropic.Anthropic') as mock_anthropic_class:
        ...
        first_tool_content = [
            MockContentBlock("tool_use", name="get_course_outline", 
                           input_data={"course_name": "MCP Introduction"}, block_id="tool_1")
        ]
        ...
        print("Round 2: After seeing the outline, Claude searches for similar courses...")
        second_tool_content = [
            MockContentBlock("tool_use", name="search_course_content", 
                           input_data={"query": "server architecture patterns"}, block_id="tool_2")
        ]
...
def demo_early_termination():
    ...
    with patch('anthropic.Anthropic') as mock_anthropic_class:
        ...
        first_tool_content = [
            MockContentBlock("tool_use", name="search_course_content", 
                           input_data={"query": "Python programming language"}, block_id="tool_1")
        ]
        first_response = MockAnthropicResponse(first_tool_content, stop_reason="tool_use")
