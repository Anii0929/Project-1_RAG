        ...
        try:
            ...
            sample_course = Course(
                ...
                lessons=[
                    ...
                    Lesson(lesson_number=1, title="Building MCP Apps", lesson_link="https://example.com/lesson1")
                ]
            )
            ...
            print(f"✓ VectorStore with sample data works: found {len(results.documents)} results")
        ...
        try:
            ...
            if course_count == 0:
                ...
                if results.error:
                    ...
                    print(f"✓ Search found {len(results.documents)} results in existing data")
