...
class TestRAGSystem(unittest.TestCase):
    ...
    def test_query_with_session_id(self):
        ...
        self.mock_session_manager.add_exchange.assert_called_once_with(
            session_id, "Continue", "Continuing our discussion..."
        )
    ...
    def test_query_with_tool_sources(self):
        ...
        # Mock AI response
        self.mock_ai_generator.generate_response.return_value = (
            "Here's what I found about algorithms"
        )
        ...
        mock_course = Course(
            ...
            lessons=[
                Lesson(
                    lesson_number=1,
                    title="Intro",
                    lesson_link="https://test.com/lesson1",
                )
            ],
        )
        mock_chunks = [
    ...
    def test_complex_query_workflow(self):
        ...
        self.assertEqual(
            response2, "Python is used for web development, data science..."
        )
