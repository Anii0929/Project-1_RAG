...
class MockAnthropicResponse:
    ...
    def __init__(self, content, stop_reason="end_turn"):
        self.content = (
            ...
            else [MockContentBlock("text", content)]
        )
...
class TestAIGenerator(unittest.TestCase):
    ...
    def test_generate_response_with_tool_use(self, mock_anthropic_class):
        ...
        final_response = MockAnthropicResponse(
            "Based on the search results, Python is..."
        )
    ...
    def test_generate_response_with_conversation_history(self, mock_anthropic_class):
        ...
        result = ai_gen.generate_response(
            "Continue the discussion", conversation_history=history
        )
    ...
    def test_base_params_configuration(self):
        ...
        expected_params = {"model": "test_model", "temperature": 0, "max_tokens": 800}
    ...
    def test_sequential_tool_calling_two_rounds(self, mock_anthropic_class):
        ...
        first_tool_content = [
            MockContentBlock(
                ...
                input_data={"course_name": "Python Course"},
                block_id="tool_1",
            )
        ]
        ...
        final_response = MockAnthropicResponse(
            "Based on the course outline and content search, here's what I found..."
        )
