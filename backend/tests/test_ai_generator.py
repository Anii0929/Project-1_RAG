...
class TestAIGenerator:
    ...
    def test_generate_response_with_tools_no_use(self, ai_generator_with_mock, tool_manager):
    ...
    def test_generate_response_with_tool_use(self, ai_generator_with_mock, tool_manager):
        ...
        final_response = Mock()
        final_response.content = [Mock(text="Based on the search results, testing is important.")]
    ...
    def test_tool_execution_with_multiple_tools(self, ai_generator_with_mock, tool_manager):
        ...
        base_params = {
            "messages": [{"role": "user", "content": "Tell me about testing and development"}],
            "system": "Test system prompt"
        }
    ...
    def test_sequential_tool_calling_two_rounds(self, ai_generator_with_mock, tool_manager):
        ...
        final_response = Mock()
        final_response.content = [Mock(text="Found courses discussing the same topic as lesson 4")]
    ...
    def test_sequential_tool_calling_early_termination(self, ai_generator_with_mock, tool_manager):
    ...
    def test_sequential_tool_calling_max_rounds(self, ai_generator_with_mock, tool_manager):
    ...
    def test_sequential_tool_calling_with_tool_error(self, ai_generator_with_mock, tool_manager):
