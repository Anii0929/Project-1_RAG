...
class TestAIGenerator:
    ...
    def test_tool_execution_flow(self, ai_generator, mock_anthropic_client):
        ...
        tool_use_content = MockToolUseContent(
            name="search_course_content",
            input_params={"query": "Python basics"}
        )
        ...
        final_response = MockAnthropicResponse([
            MockTextContent("Based on the search results, Python is a programming language...")
        ])
    ...
    def test_tool_execution_with_multiple_tools(self, ai_generator, mock_anthropic_client):
    ...
    def test_tool_execution_message_structure(self, ai_generator, mock_anthropic_client):
...
class TestAIGeneratorIntegration:
    ...
    def test_realistic_content_search_scenario(self):
        ...
        with patch('ai_generator.anthropic.Anthropic') as mock_anthropic:
            ...
            final_response = MockAnthropicResponse([
                MockTextContent("In Python, functions are defined using the 'def' keyword...")
            ])
