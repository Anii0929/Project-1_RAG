...
function addMessage(content, type, sources = null, isWelcome = false) {
    ...
    if (sources && sources.length > 0) {
        // Handle both old string format and new object format with links
...
async function startNewChat() {
    ...
    if (currentSessionId) {
        try {
            ...
            console.log('Note: Backend session clear not available, proceeding with frontend clear');
        }
    }
    
    // Reset the frontend session
